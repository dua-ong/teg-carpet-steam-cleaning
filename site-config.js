...
(function () {
  ...
  function injectFooterMap() {
    ...
    box.innerHTML =
      '<div class="teg-footer-map-inner">' +
        ...
        '</div>' +
        '<iframe title="T.E.G Carpet Steam Cleaning location map" width="600" height="220" style="border:0" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="' + MAP_EMBED + '" allowfullscreen></iframe>' +
  ...
  function injectContactMapBox() {
    ...
    var icLoc = '<svg class="teg-ico" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 21s-6-5.3-6-10a6 6 0 1 1 12 0c0 4.7-6 10-6 10z"/><circle cx="12" cy="11" r="2.2"/></svg>';
    var icPhone = '<svg class="teg-ico" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3.1-8.7A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1.9.3 1.8.6 2.6a2 2 0 0 1-.5 2.1L8.1 9.9a16 16 0 0 0 6 6l1.5-1.1a2 2 0 0 1 2.1-.4c.8.3 1.7.5 2.6.6a2 2 0 0 1 1.7 2.1z"/></svg>';
    var icMail = '<svg class="teg-ico" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 7 9 7 9-7"/></svg>';
    var icClock = '<svg class="teg-ico" viewBox="0 0 24 24" width="18" height="18" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>';
    box.innerHTML =
      '<div class="teg-map-top">' +
        '<div class="teg-map-info">' +
          '<h2>Our location</h2>' +
          '<p>Visit or pin us for service across Milwaukee and western suburbs.</p>' +
          '<div class="teg-addr-line"><span class="icon" aria-hidden="true">' + icLoc + '</span><div><strong>Address</strong><br>4111 N Port Washington Rd suite 1<br>Milwaukee, WI 53217<br>United States</div></div>' +
          '<div class="teg-addr-line"><span class="icon" aria-hidden="true">' + icPhone + '</span><div><strong>Phone</strong><br><a href="tel:+14147753705">Call Now · +1 (414) 775-3705</a></div></div>' +
          '<div class="teg-addr-line"><span class="icon" aria-hidden="true">' + icMail + '</span><div><strong>Email</strong><br><a href="mailto:contact@teg-carpetsteamcleaning.com">contact@teg-carpetsteamcleaning.com</a></div></div>' +
          '<div class="teg-addr-line"><span class="icon" aria-hidden="true">' + icClock + '</span><div><strong>Hours</strong><br>24/7 — Always Available</div></div>' +
        ...
        '<div class="teg-map-frame">' +
          '<iframe title="T.E.G location map Milwaukee" width="600" height="320" style="border:0" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="' + MAP_EMBED + '" allowfullscreen></iframe>' +
        '</div>' +
      '</div>';
  ...
  if (!document.getElementById('teg-ui-css')) {
    ...
    st.textContent = [
      ...
      '@media (max-width:768px){.teg-gmb-bar{padding:24px 14px 28px!important}.teg-gmb-bar p{font-size:14px!important;margin-bottom:16px!important}.teg-gmb-bar .teg-gmb-actions{flex-direction:column;width:100%;max-width:320px;margin:0 auto}.teg-gmb-bar a{width:100%;min-width:0;padding:12px 16px!important}}',
      ...
      '.teg-footer-map{margin:0 0 28px;padding:0 0 24px;border-bottom:1px solid rgba(255,255,255,.1);border-top:none}',
      '.teg-footer-map-inner{background:linear-gradient(145deg,rgba(14,165,233,.12),rgba(7,26,46,.9));border:1px solid rgba(125,211,252,.25);border-radius:16px;overflow:hidden;box-shadow:0 12px 40px rgba(0,0,0,.25);width:100%;max-width:100%;box-sizing:border-box}',
      ...
      '.page-inner .anim-on-scroll{opacity:1!important;transform:none!important;filter:none!important}',
      '.teg-contact-map-box{margin-top:28px;margin-bottom:8px;background:#fff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden;box-shadow:0 10px 40px rgba(10,61,107,.08)}',
      ...
      '.teg-contact-map-box .teg-addr-line span.icon{flex-shrink:0;width:36px;height:36px;border-radius:10px;background:rgba(14,165,233,.25);display:flex;align-items:center;justify-content:center;color:#7dd3fc}',
      '.teg-contact-map-box .teg-addr-line span.icon .teg-ico{display:block;width:18px;height:18px}',
      '.teg-contact-map-box .teg-addr-line a{color:#7dd3fc;font-weight:600;text-decoration:none}',
      '.teg-contact-map-box .teg-map-frame{min-height:280px;background:#e2e8f0}',
      ...
      '@media (max-width:900px){.teg-contact-map-box .teg-map-top{grid-template-columns:1fr!important}.teg-contact-map-box iframe{min-height:240px!important;height:240px!important}.teg-contact-map-box .teg-map-info{padding:22px 18px!important}}',
      '@media (max-width:768px){.teg-footer-map{margin:0 0 20px!important;padding:0 0 16px!important}.teg-footer-map iframe{height:200px!important}.teg-footer-map-head{padding:12px 14px!important;flex-direction:column;align-items:flex-start!important}.footer-grid{gap:28px!important}.sms-float{bottom:18px!important;right:16px!important;width:54px!important;height:54px!important}}',
      '@media (max-width:480px){.teg-gmb-bar a{font-size:13px!important}.teg-footer-map-addr{font-size:12px!important;padding:10px 14px 14px!important}.teg-contact-map-box .teg-map-info h2{font-size:18px!important}.header .logo-text{font-size:11px!important;max-width:120px;overflow:hidden;text-overflow:ellipsis}}',
